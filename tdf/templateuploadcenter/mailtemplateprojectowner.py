...
class MailTemplateProjectOwnerSchema(interface.Interface):
...
@implementer(MailTemplateProjectOwnerSchema)
@adapter(interface.Interface)
class MailTemplateProjectOwnerAdapter(object):
...
class MailTemplateProjectOwnerForm(AutoExtensibleForm, form.Form):
    schema = MailTemplateProjectOwnerSchema
    ...
    fields = field.Fields(MailTemplateProjectOwnerSchema, IReCaptchaForm)
    ...
    def update(self):
        ...
        super(MailTemplateProjectOwnerForm, self).update()
    ...
    def handleApply(self, action):
        ...
        api.portal.show_message(
            message=_(safe_unicode('We send your message to the owner '
...
ReCaptchaForm = wrap_form(MailTemplateProjectOwnerForm)
