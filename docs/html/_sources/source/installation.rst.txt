...
You can install the Plone add-on tdf.templateuploadcenter using zc.buildout 
...
.. image:: images/install_tdf_templateuploadcenter.png
   :width: 750
...
menu in the screenshot below.

.. image:: images/navigation_add_templateuploadcenter.png
   :width: 750

Tick the checkbox in fron of the entry ' TDF Template Upload Center' and
